...
void InsertNumber(Phone *&head, string Value, long long int num,map<pair<string,int>,Phone*>&contactTracker)
{
...
/*Phone *SortList(Phone *&head)
{
    ...
    for (auto &it : v)
    {
        InsertNumber(head2, it.first, it.second,contactTracker);
    }
    head = head2;
    return head2;
}
...
void AddNumber(Phone *&head,map<pair<string,int>,Phone*>contactTracker)
{
    string Name;
    long long int num;
    ...
    cin >> num;
    InsertNumber(head, Name, num,contactTracker);
}
void start()
{
    int a;
...
int main()
{
    ...
    string Name;
    long long int num;
    map<pair<string,int>,Phone*>contactTracker;
    start();
    system("cls");
    while (i)
    {
